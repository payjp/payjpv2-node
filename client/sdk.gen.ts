 ...
 * Get Payment Dispute
 */
export const getPaymentDispute = <ThrowOnError extends boolean = false>(options: Options<GetPaymentDisputeData, ThrowOnError>) => (options.client ?? client).get<GetPaymentDisputeResponses, GetPaymentDisputeErrors, ThrowOnError>({
    security: [{ scheme: 'basic', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 */
export const getAllPaymentDisputes = <ThrowOnError extends boolean = false>(options?: Options<GetAllPaymentDisputesData, ThrowOnError>) => (options?.client ?? client).get<GetAllPaymentDisputesResponses, GetAllPaymentDisputesErrors, ThrowOnError>({
    security: [{ scheme: 'basic', type: 'http' }, { scheme: 'bearer', type: 'http' }],
